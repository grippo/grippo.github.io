...
#   other-page     : https://example.org/destination-page
#   "another/page" : /destination-page
#
#  Result:
#   Requests to /initial-page are redirected to /destination-page
#   Requests to /other-page are redirected to https://example.org/destination-page
...
#   Redirect cool-pages https://example.org/destination-page
#
#  Result:
#   Requests to /some-page are redirected to /destination-page
#   Requests to /different-page are redirected to /destination-page
#   Requests to /cool-page are redirected to https://example.org/destination-page
#
#
...
#     "yet-another-page" : "https://example.org/destination-page",
#     "ninth-page"       : "/destination-page"
#   }
#
#  Result:
#   Requests to /some-page are redirected to /destination-page
#   Requests to /yet-another-page are redirected to https://example.org/destination-page
#   Requests to /ninth-page are redirected to /destination-page
#
#
# Author: Nick Quinlan
# Site: https://nicholasquinlan.com
# Plugin Source: https://github.com/nquinlan/jekyll-pageless-redirects
# Plugin License: MIT
# Plugin Credit: This plugin borrows heavily from alias_generator (https://github.com/tsmango/jekyll_alias_generator) by Thomas Mango (https://thomasmango.com)
